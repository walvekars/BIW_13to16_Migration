odoo.define('account_aged_receivable_inherit.account_report_inherit', function (require) {
'use strict';
...
var M2MFiltersAnalytics = Widget.extend(StandaloneFieldManagerMixin, {
    /**
     * @constructor
     * @param {Object} fields
     */
...
account_report.include({
    render_searchview_buttons: function() {
        ...
        //Both Analytic and Partner Filter
        if (this.report_options.analytic && this.report_options.partner && this.report_model == "account.aged.receivable") {
            if (!this.M2MFilters) {
                var fields = {};
                ...
                if (!_.isEmpty(fields)) {
                    ...
                    this.M2MFilters.appendTo(this.$searchview_buttons.find('.js_account_filter_all_m2m'));
                }
            } else {
                this.$searchview_buttons.find('.js_account_filter_all_m2m').append(this.M2MFilters.$el);
            }
        }
